import{r as R,i as w,a as ue,b as _e,D as b,c as fe,d as Pe,P as E,e as Be,f as $e,t as D,F as se,m as j,g as Le,h as Ke,j as J,E as te,T as ie,C as pe,k as Ze,l as B,n as Qe,o as be,p as Je,q as ve,s as Xe,u as Me,v as et,w as Y,R as U,x as T,y as f,z as tt,A as it,B as rt,G as ot,S as st}from"./indexhtml-65f00b2e.js";import{V as nt,u as ge,o as at,P as lt,O as dt,a as ht,C as ct,F as ut}from"./ComboBox-3e5aaa10.js";import{p as Ne,O as _t,f as Ce,u as ft,T as q,B as pt,s as gt,S as mt}from"./Button-7373bc48.js";import{u as ne}from"./useSimpleRenderer-40686ce4.js";R("vaadin-grid",w`
    :host {
...
`;R("vaadin-tooltip-overlay",[at,Yt],{moduleId:"lumo-tooltip-overlay"});/**
 * @license
 * Copyright (c) 2022 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */R("vaadin-tooltip-overlay",w`
    :host {
      z-index: 1100;
    }
  ...
  `,{moduleId:"vaadin-tooltip-overlay-styles"});let G;class Re extends lt(dt){static get is(){return"vaadin-tooltip-overlay"}static get template(){return G||(G=super.template.cloneNode(!0),G.content.querySelector('[part~="overlay"]').removeAttribute("tabindex"),G.content.querySelector('[part~="content"]').innerHTML="<slot></slot>"),G}static get properties(){return{position:{type:String,reflectToAttribute:!0}}}ready(){super.ready(),this.owner=this.__dataHost,this.owner._overlayElement=this}requestContentUpdate(){if(super.requestContentUpdate(),this.toggleAttribute("hidden",this.textContent.trim()===""),this.positionTarget&&this.owner){const r=getComputedStyle(this.owner);["top","bottom","start","end"].forEach(e=>{this.style.setProperty(`--vaadin-tooltip-offset-${e}`,r.getPropertyValue(`--vaadin-tooltip-offset-${e}`))})}}_updatePosition(){if(super._updatePosition(),!!this.positionTarget){if(this.position==="bottom"||this.position==="top"){const r=this.positionTarget.getBoundingClientRect(),e=this.$.overlay.getBoundingClientRect(),t=r.width/2-e.width/2;if(this.style.left){const i=e.left+t;i>0&&(this.style.left=`${i}px`)}if(this.style.right){const i=parseFloat(this.style.right)+t;i>0&&(this.style.right=`${i}px`)}}if(this.position==="start"||this.position==="end"){const r=this.positionTarget.getBoundingClientRect(),e=this.$.overlay.getBoundingClientRect(),t=r.height/2-e.height/2;this.style.top=`${e.top+t}px`}}}}customElements.define(Re.is,Re);/**
 * @license
 * Copyright (c) 2022 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const F=500;let He=F,Ve=F,We=F;const Z=new Set;let k=!1,H=null,V=null;class Ut{constructor(r){this.host=r}get openedProp(){return this.host.manual?"opened":"_autoOpened"}get focusDelay(){const r=this.host;return r.focusDelay!=null&&r.focusDelay>0?r.focusDelay:He}get hoverDelay(){const r=this.host;return r.hoverDelay!=null&&r.hoverDelay>0?r.hoverDelay:Ve}get hideDelay(){const r=this.host;return r.hideDelay!=null&&r.hideDelay>0?r.hideDelay:We}open(r={immediate:!1}){const{immediate:e,hover:t,focus:i}=r,o=t&&this.hoverDelay>0,s=i&&this.focusDelay>0;!e&&(o||s)&&!this.__closeTimeout?this.__warmupTooltip(s):this.__showTooltip()}close(r){!r&&this.hideDelay>0?this.__scheduleClose():(this.__abortClose(),this._setOpened(!1)),this.__abortWarmUp(),k&&(this.__abortCooldown(),this.__scheduleCooldown())}_isOpened(){return this.host[this.openedProp]}_setOpened(r){this.host[this.openedProp]=r}__flushClosingTooltips(){Z.forEach(r=>{r._stateController.close(!0),Z.delete(r)})}__showTooltip(){this.__abortClose(),this.__flushClosingTooltips(),this._setOpened(!0),k=!0,this.__abortWarmUp(),this.__abortCooldown()}__warmupTooltip(r){this._isOpened()||(k?this.__showTooltip():this.__scheduleWarmUp(r))}__abortClose(){this.__closeTimeout&&(clearTimeout(this.__closeTimeout),this.__closeTimeout=null)}__abortCooldown(){V&&(clearTimeout(V),V=null)}__abortWarmUp(){H&&(clearTimeout(H),H=null)}__scheduleClose(){this._isOpened()&&(Z.add(this.host),this.__closeTimeout=setTimeout(()=>{Z.delete(this.host),this.__closeTimeout=null,this._setOpened(!1)},this.hideDelay))}__scheduleCooldown(){V=setTimeout(()=>{V=null,k=!1},this.hideDelay)}__scheduleWarmUp(r){const e=r?this.focusDelay:this.hoverDelay;H=setTimeout(()=>{H=null,k=!0,this.__showTooltip()},e)}}class ze extends _t(it(te(E))){static get is(){return"vaadin-tooltip"}static get template(){return B`
      <style>
        :host {
          display: none;
        }
...
`;rt("user-color-props",qt);const je=document.createElement("style");je.textContent="html { --vaadin-avatar-size: var(--lumo-size-m); }";document.head.appendChild(je);R("vaadin-avatar",w`
    :host {
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Ye=document.createElement("template");Ye.innerHTML=`
  <style>
    @font-face {
...
`;document.head.appendChild(Ye.content);/**
 * @license
 * Copyright (c) 2020 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */let le=class extends ot(te(ie(pe(E)))){static get template(){return B`
      <style>
        :host {
 ...
 */class Te extends pe(E){static get template(){return B`
      ...
      <slot></slot>
    `}static get is(){return"vaadin-grid-filter"}static get properties(){return{path:String,value:{type:String,notify:!0},_textField:{type:Object}}}static get observers(){return["_filterChanged(path, value, _textField)"]}ready(){super.ready(),this._filterController=new st(this,"","vaadin-text-field",{initializer:r=>{r.addEventListener("value-changed",e=>{this.value=e.detail.value}),this._textField=r}}),this.addController(this._filterController)}_filterChanged(r,e,t){r===void 0||e===void 0||!t||this._previousValue===void 0&&e===""||(t.value=e,this._previousValue=e,this._debouncerFilterChanged=b.debounce(this._debouncerFilterChanged,D.after(200),()=>{this.dispatchEvent(new CustomEvent("filter-changed",{bubbles:!0}))}))}focus(){this._textField&&this._textField.focus()}}customElements.define(Te.is,Te);/**
 * @license
 * Copyright (c) 2016 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */let de=class extends X{static get is(){return"vaadin-grid-filter-column"}static get properties(){return{path:String,header:String}}static get observers(){return["_onHeaderRendererOrBindingChanged(_headerRenderer, _headerCell, path, header, _filterValue)"]}constructor(){super(),this.__boundOnFilterValueChanged=this.__onFilterValueChanged.bind(this)}_defaultHeaderRenderer(r,e){let t=r.firstElementChild,i=t?t.firstElementChild:void 0;t||(t=document.createElement("vaadin-grid-filter"),i=document.createElement("vaadin-text-field"),i.setAttribute("theme","small"),i.setAttribute("style","max-width: 100%;"),i.setAttribute("focus-target",""),i.addEventListener("value-changed",this.__boundOnFilterValueChanged),t.appendChild(i),r.appendChild(t)),t.path=this.path,t.value=this._filterValue,i.__rendererValue=this._filterValue,i.value=this._filterValue,i.label=this.__getHeader(this.header,this.path)}_computeHeaderRenderer(){return this._defaultHeaderRenderer}__onFilterValueChanged(r){r.detail.value!==r.target.__rendererValue&&(this._filterValue=r.detail.value)}__getHeader(r,e){if(r)return r;if(e)return this._generateHeader(e)}};customElements.define(de.is,de);const Qt={},Jt=Y({elementClass:de,events:Qt,react:U,tagName:"vaadin-grid-filter-column"});function Xt(a,r){const[e,t]=ne(a.footerRenderer),[i,o]=ge(a.renderer??a.children);return f.jsxs(Jt,{...a,footerRenderer:t,ref:r,renderer:o,children:[e,i]})}const Fe=T.forwardRef(Xt),ei=w`
  :host([theme~='margin']) {
...
`;R("vaadin-horizontal-layout",ei,{moduleId:"lumo-horizontal-layout"});/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */let he=class extends te(ie(E)){static get template(){return B`
      <style>
        :host {
          display: flex;
          box-sizing: border-box;
      ...
      <slot></slot>
    `}static get is(){return"vaadin-horizontal-layout"}};customElements.define(he.is,he);const ti={},De=Y({elementClass:he,events:ti,react:U,tagName:"vaadin-horizontal-layout"});R("vaadin-grid-sorter",w`
    :host {
...
`;document.head.appendChild(Ue.content);class Oe extends ie(Pe(E)){static get template(){return B`
      <style>
        :host {
          display: inline-flex;
          cursor: pointer;
    ...
    `}static get is(){return"vaadin-grid-sorter"}static get properties(){return{path:String,direction:{type:String,reflectToAttribute:!0,notify:!0,value:null},_order:{type:Number,value:null},_isConnected:{type:Boolean,observer:"__isConnectedChanged"}}}static get observers(){return["_pathOrDirectionChanged(path, direction)"]}ready(){super.ready(),this.addEventListener("click",this._onClick.bind(this))}connectedCallback(){super.connectedCallback(),this._isConnected=!0}disconnectedCallback(){super.disconnectedCallback(),this._isConnected=!1,!this.parentNode&&this._grid&&this._grid.__removeSorters([this])}_pathOrDirectionChanged(){this.__dispatchSorterChangedEvenIfPossible()}__isConnectedChanged(r,e){e!==!1&&this.__dispatchSorterChangedEvenIfPossible()}__dispatchSorterChangedEvenIfPossible(){this.path===void 0||this.direction===void 0||!this._isConnected||(this.dispatchEvent(new CustomEvent("sorter-changed",{detail:{shiftClick:!!this._shiftClick,fromSorterClick:!!this._fromSorterClick},bubbles:!0,composed:!0})),this._fromSorterClick=!1,this._shiftClick=!1)}_getDisplayOrder(r){return r===null?"":r+1}_onClick(r){if(r.defaultPrevented)return;const e=this.getRootNode().activeElement;this!==e&&this.contains(e)||(r.preventDefault(),this._shiftClick=r.shiftKey,this._fromSorterClick=!0,this.direction==="asc"?this.direction="desc":this.direction==="desc"?this.direction=null:this.direction="asc")}}customElements.define(Oe.is,Oe);/**
 * @license
 * Copyright (c) 2016 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */let ce=class extends X{static get is(){return"vaadin-grid-sort-column"}static get properties(){return{path:String,direction:{type:String,notify:!0}}}static get observers(){return["_onHeaderRendererOrBindingChanged(_headerRenderer, _headerCell, path, header, direction)"]}constructor(){super(),this.__boundOnDirectionChanged=this.__onDirectionChanged.bind(this)}_defaultHeaderRenderer(r,e){let t=r.firstElementChild;t||(t=document.createElement("vaadin-grid-sorter"),t.addEventListener("direction-changed",this.__boundOnDirectionChanged),r.appendChild(t)),t.path=this.path,t.__rendererDirection=this.direction,t.direction=this.direction,t.textContent=this.__getHeader(this.header,this.path)}_computeHeaderRenderer(){return this._defaultHeaderRenderer}__onDirectionChanged(r){r.detail.value!==r.target.__rendererDirection&&(this.direction=r.detail.value)}__getHeader(r,e){if(r)return r;if(e)return this._generateHeader(e)}};customElements.define(ce.is,ce);const ii={onDirectionChanged:"direction-changed"},ri=Y({elementClass:ce,events:ii,react:U,tagName:"vaadin-grid-sort-column"});function oi(a,r){const[e,t]=ne(a.headerRenderer),[i,o]=ne(a.footerRenderer),[s,n]=ge(a.renderer??a.children);return f.jsxs(ri,{...a,footerRenderer:o,headerRenderer:t,ref:r,renderer:n,children:[e,i,s]})}const Q=T.forwardRef(oi);function Di(){const[a,r]=T.useState([]),[e,t]=T.useState(!1);T.useEffect(()=>{Ce().then(_=>{console.log(_),r(_.map((g,C)=>({...g,displayName:`${g.StudentName} ${g.Studentsurname}`,colorIndex:C})))}).catch(_=>{console.error("Error fetching data:",_)})},[]);const{model:i,submit:o,field:s,invalid:n,errors:l,required:c}=ft(mt,{onSubmit:async _=>{t(!0);try{await gt(_.StudentName,_.Studentsurname,_.Studentage,_.grade,_.availablility,_.course)}catch{}finally{t(!1),Ce().then(g=>{console.log(g),r(g.map((C,$)=>({...C,displayName:`${C.StudentName} ${C.Studentsurname}`,colorIndex:$})))})}}}),d=["Software Engineering","Web Development","DevOPS","Data Engineering"],h=({item:_})=>f.jsxs(De,{style:{alignItems:"center"},theme:"spacing",children:[f.jsx(Zt,{img:_.StudentName,name:_.StudentName}),f.jsx("span",{theme:"badge",children:_.StudentName})]});let u=!0;const p=_=>f.jsx("span",{theme:`badge ${_.availablility===u?"success":"error"}`,children:_.availablility});return f.jsx("div",{children:f.jsx(f.Fragment,{children:f.jsxs(De,{theme:"spacing padding",className:"height-4xl",style:{justifyContent:"center"},children:[f.jsxs(jt,{items:a,theme:"wrap-cell-content",children:[f.jsx(Fe,{placeholder:"Search",header:"Search Name",path:"displayName",flexGrow:0,width:"200px",children:h}),f.jsx(Fe,{path:"studentcode",placeholder:"Search ",header:"Search By Code"}),f.jsx(Q,{path:"StudentName",header:"Names"}),f.jsx(Q,{path:"Studentsurname",header:"Surnames"}),f.jsx(Q,{path:"course",header:"Courses"}),f.jsx(Q,{header:"Present",autoWidth:!0,children:({item:_})=>p(_)})]}),f.jsxs(ht,{theme:"spacing padding",children:[f.jsx(q,{required:!0,label:"Student name",...s(i.StudentName)}),f.jsx(q,{label:"Student surname",...s(i.Studentsurname)}),f.jsx(q,{label:"Student Age",...s(i.Studentage)}),f.jsx(q,{label:"Student Grade",...s(i.grade)}),f.jsx(ct,{label:"Availability",...s(i.availablility)}),f.jsx(ut,{allowCustomValue:!0,label:"Student course",...s(i.course),helperText:"Select or type a browser",items:d}),f.jsx(pt,{theme:"primary",onClick:o,disabled:n||e,children:"Save"})]})]})})})}export{Di as default};
